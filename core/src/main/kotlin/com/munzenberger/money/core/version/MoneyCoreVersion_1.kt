...
class MoneyCoreVersion_1 : ApplicableVersion<MoneyDatabase> {
    ...
    override fun apply(obj: MoneyDatabase) {
        ...
        with (obj) {
            ...
            execute(Query.createTable("ACCOUNTS")
            ...
            execute(Query.createTable("TRANSACTIONS")
            ...
            execute(Query.createIndex("TRANSACTION_ACCOUNT_INDEX", "TRANSACTIONS")
                    .column("TRANSACTION_ACCOUNT_ID")
                    .build())

            execute(Query.createTable("TRANSFERS")
            ...
            execute(Query.createIndex("TRANSFER_TRANSACTION_ACCOUNT_INDEX", "TRANSFERS")
                    .column("TRANSFER_TRANSACTION_ID")
                    .column("TRANSFER_ACCOUNT_ID")
                    .build())

            execute(Query.createTable("ENTRIES")
            ...
            execute(Query.createIndex("ENTRY_TRANSACTION_INDEX", "ENTRIES")
                    .column("ENTRY_TRANSACTION_ID")
                    .build())

            execute(Query.createTable("STATEMENTS")
