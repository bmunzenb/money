...
class ObservableMoneyDatabase(
    ...
    fun subscribe(block: Runnable): Subscription = subscribe(Executors.PLATFORM, block)

    override fun subscribe(
        executor: Executor,
        block: Runnable,
    ): Subscription = observable.subscribe(executor, block)
}
...
private class ObservableTransactionQueryExecutor(
    ...
    override fun createTransaction(): TransactionQueryExecutor = ObservableTransactionQueryExecutor(executor.createTransaction())
