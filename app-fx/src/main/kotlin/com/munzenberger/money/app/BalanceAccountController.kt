...
class BalanceAccountController {
    ...
    fun start(
        ...
        statementBalanceLabel.textProperty().bind(
            viewModel.statementBalanceProperty.toBinding {
                statementBalanceLabel.pseudoClassStateChanged(moneyNegativePseudoClass, it.isNegative)
                it.toStringWithoutCurrency()
            },
        )

        clearedBalanceLabel.textProperty().bind(
            viewModel.clearedBalanceProperty.toBinding {
                clearedBalanceLabel.pseudoClassStateChanged(moneyNegativePseudoClass, it.isNegative)
                it.toStringWithoutCurrency()
            },
        )

        differenceLabel.textProperty().bind(
            viewModel.differenceProperty.toBinding {
